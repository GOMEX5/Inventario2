...
namespace Inventario.Adoptors.SQLServerDataAccess.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Laboratorioslab_id = table.Column<Guid>(nullable: true),
                    created_at = table.Column<DateTime>(nullable: false),
                    updated_at = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tb_pc_tab_Laboratorios_Laboratorioslab_id",
                        column: x => x.Laboratorioslab_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tb_pc_Laboratorioslab_id",
                table: "tb_pc",
                column: "Laboratorioslab_id");
        }
